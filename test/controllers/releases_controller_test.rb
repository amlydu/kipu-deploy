...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { release_main_id: @release.release_main_id } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { release_main_id: @release.release_main_id } }
